...
//    @Query("FROM Friendship " +
//            "WHERE dstPerson = :currentPerson " +
//            "AND srcPerson = :dstPerson and status.code = :code")
//    List<Friendship> findRequests(Person currentPerson, Person dstPerson, FriendshipStatusCode code);
